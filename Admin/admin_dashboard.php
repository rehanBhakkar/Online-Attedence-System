...
<div class="cards">
  <div class="card1"><a href="http://localhost/Online%20Attedence%20System/Admin/user_view.php"> <h6>student </h6></a> <h5> <?php $sql = "SELECT * FROM users";
if ($result=mysqli_query($conn,$sql)) {
    $rowcount=mysqli_num_rows($result);
    echo $rowcount; 
}?> <i class="fas fa-users"></i></h5></div>
<!--   <div class="card2"><h6>Teacher</h6> <h5> 5 <i class="fas fa-book-open"></i></h5> </div>
  <div class="card2"><h6>Subjects</h6> <h5> 20  <i class="fas fa-book-open"></i></h5> </div>
...
<div class="content">
  <div class="graph1"> <h5 style="padding: 0px; color: skyblue;">Users Overview</h5><canvas id="myChart"></canvas> </div>
