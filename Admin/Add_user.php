...
<form method="post" enctype="multipart/form-data">
  <div class="form-group">
    <input type="name" name="fname" class="form-control" id="Name" aria-describedby="emailHelp" placeholder="Please enter user first name"autofill="on" required>
  </div>
  <div class="form-group">
    <input type="name" name="pass" class="form-control" id="pass" aria-describedby="emailHelp" placeholder="Please enter user password" required>
  </div>
    <div class="form-group">
  ...
  <div class="form-group">
    <input type="name" name="father_name" class="form-control" id="father_name" aria-describedby="emailHelp" placeholder="Please enter user father name" required>
  </div>
  <div class="form-group">
    <input type="name" name="roll_no" class="form-control" id="roll_no" aria-describedby="emailHelp" placeholder="Please enter user roll number" required>
  </div>
    <div class="form-group">
  ...
  <div class="form-group">
     <input type="date" id="datepicker" name="dob" placeholder="Please enter user date of birth" required />
  </div>
  <div class="form-group">
