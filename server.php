...
$sql = "INSERT INTO users (email,fname,lname,father_name,roll_no,dob,age_y,age_m,password1,password2,dp,gender,date_time) VALUES ('$email','$fname','$lname','$father_name','$roll_no','$dob','$age_y','$age_m','$password','$password','$filename','$gender','$date')";
$hallo=mysqli_query($conn, $sql);
